...
/**
 * 这个类是根据androidx.recyclerview:recyclerview:1.2.1版本的{@link SnapHelper}代码实现.
 * 最好更新下这个类的实现.
 *
 * @author 谢朝军
 */
public abstract class LoopSnapHelper extends RecyclerView.OnFlingListener {
    ...
    private boolean snapFromFling(@NonNull RecyclerView.LayoutManager layoutManager, int velocityX,
        ...
        if (layoutManager instanceof LoopLinearLayoutManager) {
            LoopLinearLayoutManager loopLinearLayoutManager = (LoopLinearLayoutManager) layoutManager;
            loopLinearLayoutManager.startSmoothScrollForFling(smoothScroller, velocityX, velocityY);
        } else {
