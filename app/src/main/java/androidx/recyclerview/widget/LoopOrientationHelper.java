...
/**
 * 这个类是根据androidx.recyclerview:recyclerview:1.2.1版本的{@link OrientationHelper}代码实现.
 * 最好更新下这个类的实现.
 *
 * @author 谢朝军
 */
public abstract class LoopOrientationHelper {
    ...
    private LoopOrientationHelper(RecyclerView.LayoutManager layoutManager) {
     ...
     */
    public static LoopOrientationHelper createOrientationHelper(
     ...
     * @return A new OrientationHelper
     */
    public static LoopOrientationHelper createHorizontalHelper(
            RecyclerView.LayoutManager layoutManager) {
        return new LoopOrientationHelper(layoutManager) {
            @Override
     ...
     * @return A new OrientationHelper
     */
    public static LoopOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new LoopOrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
