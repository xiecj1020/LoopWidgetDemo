...
/**
 * 这个类是根据androidx.recyclerview:recyclerview:1.2.1版本的{@link LinearLayoutManager}代码
 * 实现RecyclerView可以在水平与竖直方向左右循环滚动。如果使用的RecyclerView版本有更新的，
 * 最好更新下这个类的实现.
 *
 * @author 谢朝军
 */
public class LoopLinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    static class LayoutState {
        ...
        View next(RecyclerView.Recycler recycler, RecyclerView.State state) {
            ...
            mCurrentPosition = (mCurrentPosition + itemCount) % itemCount;
            return view;
        }
