...
/**
 * 这个类是根据androidx.viewpager2:viewpager2:1.0.0版本的{@link ViewPager2}代码实现.
 *
 * @author 谢朝军
 */
public final class LoopViewPager2 extends ViewGroup {
    /** @hide */
    ...
    private RecyclerView.AdapterDataObserver mCurrentItemDataSetChangeObserver =
            new DataSetChangeObserver() {
                ...
                public void onChanged() {
                    ...
                    mLoopScrollEventAdapter.notifyDataSetChangeHappened();
                }
            };

    private LoopLinearLayoutManager mLayoutManager;
    ...
    private LoopPageTransformerAdapter mLoopPageTransformerAdapter;
    ...
    public LoopViewPager2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        mLoopScrollEventAdapter = new LoopScrollEventAdapter(this);
        // Create FakeDrag before attaching PagerSnapHelper, same reason as above
        mLoopFakeDragger = new LoopFakeDrag(this, mLoopScrollEventAdapter, mRecyclerView);
        ...
        mRecyclerView.addOnScrollListener(mLoopScrollEventAdapter);

        mPageChangeEventDispatcher = new CompositeOnPageChangeCallback(3);
        mLoopScrollEventAdapter.setOnPageChangeCallback(mPageChangeEventDispatcher);
        ...
        mLoopPageTransformerAdapter = new LoopPageTransformerAdapter(mLayoutManager);
        mPageChangeEventDispatcher.addOnPageChangeCallback(mLoopPageTransformerAdapter);
    ...
    void updateCurrentItem() {
        ...
        if (snapPosition != mCurrentItem && getScrollState() == SCROLL_STATE_IDLE) {
            /** TODO: revisit if push to {@link LoopScrollEventAdapter} / separate component */
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll) {
        ...
        if (item == mCurrentItem && mLoopScrollEventAdapter.isIdle()) {
        ...
        if (!mLoopScrollEventAdapter.isIdle()) {
            // Scroll in progress, overwrite previousItem with actual current position
            previousItem = mLoopScrollEventAdapter.getRelativeScrollPosition();
        }

        // 3. Perform the necessary scroll actions on RecyclerView

        mLoopScrollEventAdapter.notifyProgrammaticScroll(item, smoothScroll);
        if (!smoothScroll) {
    ...
    public int getScrollState() {
        return mLoopScrollEventAdapter.getScrollState();
    }
    ...
    public boolean beginFakeDrag() {
        return mLoopFakeDragger.beginFakeDrag();
    }
    ...
    public boolean fakeDragBy(@SuppressLint("SupportAnnotationUsage") @Px float offsetPxFloat) {
        return mLoopFakeDragger.fakeDragBy(offsetPxFloat);
    }
    ...
    public boolean endFakeDrag() {
        return mLoopFakeDragger.endFakeDrag();
    }
    ...
    public boolean isFakeDragging() {
        return mLoopFakeDragger.isFakeDragging();
    }
    ...
    public void setPageTransformer(@Nullable PageTransformer transformer) {
        ...
        if (transformer == mLoopPageTransformerAdapter.getPageTransformer()) {
            return;
        }
        mLoopPageTransformerAdapter.setPageTransformer(transformer);
        requestTransform();
    }
    ...
    public void requestTransform() {
        if (mLoopPageTransformerAdapter.getPageTransformer() == null) {
            return;
        }
        double relativePosition = mLoopScrollEventAdapter.getRelativeScrollPosition();
        ...
        mLoopPageTransformerAdapter.onPageScrolled(position, positionOffset, positionOffsetPx);
    }
     ...
     */
    public abstract static class OnPageChangeCallback extends ViewPager2.OnPageChangeCallback{
        /**
     ...
     */
    public interface PageTransformer extends ViewPager2.PageTransformer{
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageForward =
                new AccessibilityViewCommand() {
                    ...
                    public boolean perform(@NonNull View view,
                        ...
                        LoopViewPager2 viewPager = (LoopViewPager2) view;
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(LoopViewPager2.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(LoopViewPager2.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(LoopViewPager2.this);
        ...
        void updatePageAccessibilityActions() {
            LoopViewPager2 viewPager = LoopViewPager2.this;
