...
/**
 * 这个类是根据androidx.viewpager2:viewpager2:1.0.0版本的{@link ScrollEventAdapter}代码实现.
 *
 * @author 谢朝军
 */
final class LoopScrollEventAdapter extends RecyclerView.OnScrollListener {
    /** @hide */
    @Retention(SOURCE)
    ...
    private final @NonNull LoopViewPager2 mViewPager;
    private final @NonNull RecyclerView mRecyclerView;
    private final @NonNull
    LoopLinearLayoutManager mLayoutManager;
    ...
    LoopScrollEventAdapter(@NonNull LoopViewPager2 viewPager) {
        mViewPager = viewPager;
        mRecyclerView = mViewPager.mRecyclerView;
        //noinspection ConstantConditions
        mLayoutManager = (LoopLinearLayoutManager) mRecyclerView.getLayoutManager();
    ...
    private void updateScrollEventValues() {
        ...
        if (values.mOffsetPx < 0) {
            ...
            if (new LoopAnimateLayoutChangeDetector(mLayoutManager).mayHaveInterferingAnimations()) {
