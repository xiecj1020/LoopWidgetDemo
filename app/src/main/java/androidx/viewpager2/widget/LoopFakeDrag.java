...
import static androidx.viewpager2.widget.LoopViewPager2.ORIENTATION_HORIZONTAL;
...
/**
 * 这个类是根据androidx.viewpager2:viewpager2:1.0.0版本的{@link FakeDrag}代码实现.
 *
 * @author 谢朝军
 */
final class LoopFakeDrag {
    private final LoopViewPager2 mViewPager;
    private final LoopScrollEventAdapter mScrollEventAdapter;
    ...
    LoopFakeDrag(LoopViewPager2 viewPager, LoopScrollEventAdapter scrollEventAdapter,
