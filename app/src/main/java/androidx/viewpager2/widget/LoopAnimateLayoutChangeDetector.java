...
/**
 * 这个类是根据androidx.viewpager2:viewpager2:1.0.0版本的{@link AnimateLayoutChangeDetector}代码实现.
 *
 * @author 谢朝军
 */
final class LoopAnimateLayoutChangeDetector {
    ...
    LoopAnimateLayoutChangeDetector(@NonNull LoopLinearLayoutManager llm) {
        mLayoutManager = llm;
    }
